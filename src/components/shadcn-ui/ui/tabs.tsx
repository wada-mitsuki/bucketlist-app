...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-evenly bg-white text-muted-foreground border-b',
      className,
    )}
    {...props}
  />
